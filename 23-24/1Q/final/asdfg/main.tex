...
\begin{document}
	...
	{Name:\underline{\hspace{2in}}\text{     }{Roll Number:\underline{\hspace{0.5in}}\text{     }{Section:\underline{\hspace{0.3in}}{Time Allowed: \bf{2 hours}}
				...
				\begin{questions}
					...
					\begin{choices}
						\choice The strong and gravitational force only
						\choice The strong and weak forces only
						\choice The electromagnetic and gravitational forces only
						\choice The electromagnetic, gravitational, and weak forces only
						\choice The electromagnetic, gravitational, and strong forces only
					\end{choices}
					...
					\begin{oneparchoices}
						...
						\choice None of the above
					\end{oneparchoices}
					\question The position y of a particle moving along the y axis depends on the time $t$ according to the equation $y = at-bt2$. The dimensions of the quantities a and b are respectively: \\
					\begin{oneparchoices}
