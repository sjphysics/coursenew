...
\begin{document}
	...
	\begin{questions}
		...
		\begin{itemize}
			...
			\begin{center}
				\includegraphics[scale=0.5]{coordinatesystem}	
			\end{center}
		...
		4x+y = 8.\vspace{2in}
		\question \begin{itemize}
			\item Vector $\vec{B}$ is 7.0 cm long and vector $\vec{A}$ is 4.0 cm long. Find the angle between these two vectors when $|\vec{A}+\vec{B}|$=$|\vec{A}-\vec{B}|$\vspace{2in}
			\item Draw the vectors and join their tails after you have found the angle between them. What special kind of parallelogram have you constructed using the two vectors and their extensions?\vspace{1cm}
		\end{itemize}
